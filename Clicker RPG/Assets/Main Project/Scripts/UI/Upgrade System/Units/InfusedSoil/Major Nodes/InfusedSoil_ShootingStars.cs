...
public class InfusedSoil_ShootingStars : MajorUpgradeNode
{
    ...
    {
        if (isPurchased)
            return "<size=18>SHOOTING STARS <NYI>:\n<color=#00FF50>During the <color=#FFFFFF>Night</color>, shooting stars may shower down and grant you a burst of mana.</color>";


        return "<size=18>SHOOTING STARS <NYI>:\n<color=#5E5E5E>During the Night, shooting stars may shower down and grant you a burst of mana.</color>";
    }

    public override string FetchUpgradeListText()
    {
        return "<color=#00FF50>+ During the Night, shooting stars may shower down and grant you a burst of mana.</color>\n";
    }
