...
public class InfusedSoil_WindWaker : MajorUpgradeNode
{
    ...
    {
        if (isPurchased)
            return "<size=18>WIND WAKER <NYI>:\n<color=#00FF50>There is a <color=#FFFFFF>25%</color> chance when a <color=#FFFFFF>Storm</color> begins, that a powerful gust of wind will blow the storm clouds away and clear the weather effect.</color>";


        return "<size=18>WIND WAKER <NYI>:\n<color=#5E5E5E>There is a 25% chance when a Storm begins, that a powerful gust of wind will blow the storm clouds away and clear the weather effect.</color>";
    }

    public override string FetchUpgradeListText()
    {
        return "<color=#00FF50>+ 25% chance to stop a storm before it begins.</color>\n";
    }
