...
public class RuinsMajor_Growth : MajorUpgradeNode
{
    ...
    {
        if (isPurchased)
            return "<size=18>GROWTH <NYI>:\n<color=#00FF50>Every rank of your Ruins will increase its efficiency by <color=#FFFFFF>1%</color>, stacking infinitely.</color>";


        return "<size=18>GROWTH <NYI>:\n<color=#5E5E5E>Every rank of your Ruins will increase its efficiency by 1%, stacking infinitely.</color>";
    }

    public override string FetchUpgradeListText()
    {
        return "<color=#00FF50>+ 1% efficiency for every rank of your ruins.</color>\n";
    }
