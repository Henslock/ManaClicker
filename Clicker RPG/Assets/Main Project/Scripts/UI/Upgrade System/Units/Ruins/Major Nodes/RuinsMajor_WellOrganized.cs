...
public class RuinsMajor_WellOrganized : MajorUpgradeNode
{
    ...
    {
        if (isPurchased)
            return "<size=18>WELL ORGANIZED <NYI>:\n<color=#00FF50>Research time reduced by <color=#FFFFFF>15%</color>.</color>";


        return "<size=18>WELL ORGANIZED <NYI>:\n<color=#5E5E5E>Research time reduced by 15%.</color>";
    }

    public override string FetchUpgradeListText()
    {
        return "<color=#00FF50>+ Research time reduced by 15%.</color>\n";
    }
