...
public class RuinsMajor_Meditation : MajorUpgradeNode
{
    ...
    {
        if (isPurchased)
            return "<size=18>MEDITATION <NYI>:\n<color=#00FF50>Increases your <color=#FFFFFF>Intellect</color> by <color=#FFFFFF>5%</color>.</color>";


        return "<size=18>MEDITATION <NYI>:\n<color=#5E5E5E>Increases your Intellect by 5%.</color>";
    }

    public override string FetchUpgradeListText()
    {
        return "<color=#00FF50>+ 5% increased Intellect.</color>\n";
    }
