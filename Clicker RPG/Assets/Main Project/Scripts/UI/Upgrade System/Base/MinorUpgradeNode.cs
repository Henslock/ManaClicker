...
public class MinorUpgradeNode : MonoBehaviour, IUnitUpgrade
{
    public bool isActive { get; protected set; }
    public double upgradeAmount { get; protected set; }
    public bool isPurchased { get; protected set; }
    public UpgradeNodeType nodeType => UpgradeNodeType.MINOR;
    ...
    public virtual Dictionary<string, double> GetEffectAndAmount()
    {
