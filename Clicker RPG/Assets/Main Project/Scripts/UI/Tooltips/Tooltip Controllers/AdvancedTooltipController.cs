...
public class AdvancedTooltipController : MonoBehaviour, ITooltipSetup
{
    ...
    {
        AdvancedTooltip advTooltip = tooltip.GetComponent<AdvancedTooltip>();

        RectTransform controllerRect = gameObject.GetComponent<RectTransform>();

        controllerRect.sizeDelta = new Vector2(advTooltip.MaxTooltipWidth, controllerRect.sizeDelta.y);
        Header.GetComponent<TextMeshProUGUI>().text = advTooltip.HeaderText;
        Description.GetComponent<TextMeshProUGUI>().text = advTooltip.DescriptionText;
        Status.GetComponent<TextMeshProUGUI>().text = advTooltip.StatusText;
        fadeTimer = advTooltip.fadeDelay;
